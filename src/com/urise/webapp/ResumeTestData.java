...
public class ResumeTestData {
    ...
    public static Resume fillResume(String uuid, String fullName){
        ...
        testResume.getSections().put(SectionType.ACHIEVEMENTS, new BulletedListSection(("С 2013 года: разработка проектов \"Разработка Web приложения\",\"Java Enterprise\", \"Многомодульный maven. Многопоточность. XML (JAXB/StAX). Веб сервисы (JAX-RS/SOAP). Удаленное взаимодействие (JMS/AKKA)\". Организация онлайн стажировок и ведение проектов. Более 1000 выпускников.\n" +
        ...
        testResume.getSections().put(SectionType.QUALIFICATION, new BulletedListSection("JEE AS: GlassFish (v2.1, v3), OC4J, JBoss, Tomcat, Jetty, WebLogic, WSO2\n" +
        ...
        testResume.getSections().put(SectionType.EDUCATION,new OrganizationSection("Coursera\n" + "https://www.coursera.org/learn/progfun1\n" +
        ...
        testResume.getSections().put(SectionType.EXPERIENCE,new OrganizationSection("Java Online Projects\n" + "https://javaops.ru/\n" +
